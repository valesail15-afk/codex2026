...
const HOME_TOKENS = ['主胜', 'home', 'homewin', 'std_w', 'standard_w', '涓昏儨', '普通胜'];
const DRAW_TOKENS = ['平', 'draw', 'std_d', 'standard_d', '骞?', '普通平', '平局'];
const AWAY_TOKENS = ['客胜', 'away', 'awaywin', 'std_l', 'standard_l', '瀹㈣儨', '普通负'];
